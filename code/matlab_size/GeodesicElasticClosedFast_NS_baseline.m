%Same as GeodesicElasticClosed, but with Find_Rotation_and_Seed_unique_fast
%instead of the regular in line 33 and reparam turned off
function d = GeodesicElasticClosedFast_NS_baseline(p1,p2)
...
[q2n,R] = Find_Rotation_and_Seed_unique_fast(q1,q2,0); 
