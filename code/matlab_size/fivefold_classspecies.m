...
%cat_vec: is an n length vector with the categories we would like to classify by
cat_vec = LM1_ref.species; 
writematrix(cat_vec,strcat(tooth_type,"cat_vec_species.csv"));
...
writematrix(folds,strcat(tooth_type,"folds_species.csv"));
...
writetable(output,'LM1_5foldspecies_results.csv')